...
class SignalServiceEnvelope {
  ...
  constructor(input: ByteArray, serverDeliveredTimestamp: Long) : this(
    Envelope.ADAPTER.decode(input), serverDeliveredTimestamp
  )
   ...
   */
  fun hasSourceServiceId(): Boolean {
    return proto.sourceServiceId != null
  }
  ...
  fun hasDestinationUuid(): Boolean {
    return UuidUtil.isUuid(proto.destinationServiceId)
  }

  val destinationServiceId: String?
    get() = proto.destinationServiceId
  val isUrgent: Boolean
    get() = proto.urgent != null && proto.urgent

  fun hasUpdatedPni(): Boolean {
    return UuidUtil.isUuid(proto.updatedPni)
  }
  ...
  companion object {
    ...
    fun deserialize(serialized: ByteArray): SignalServiceEnvelope {
      ...
      val sourceServiceId = if (proto.sourceServiceId != null) parseOrNull(
        proto.sourceServiceId
      ) else null
