...
public class ProvisioningSocket {
  ...
  public ProvisioningSocket(SignalServiceConfiguration signalServiceConfiguration, String userAgent) {
    connection = new OkHttpWebSocketConnection(
        ...
        new HealthMonitor() {
          @Override
          public void onServerTimestamp(long serverTimestamp, boolean isIdentifiedWebSocket) {
          }

          @Override
          public void onReceivedAlerts(@NotNull String @NotNull [] alerts, boolean isIdentifiedWebSocket) {
          }
  ...
  public ProvisioningAddress getProvisioningUuid() throws TimeoutException, IOException {
    ...
    ProvisioningAddress msg   = ProvisioningAddress.ADAPTER.decode(bytes);
    return msg;
  }
