...
class SignalServiceEnvelope {
  ...
  constructor(
    ...
    if (reportingToken != null) {
      builder.report_spam_token(ByteString.of(*reportingToken))
    }
    proto = builder.build()
  ...
  val sourceServiceId: ServiceId?
    get() = ServiceId.parseOrNull(proto.sourceServiceId, proto.sourceServiceIdBinary)

  fun hasSourceDevice(): Boolean {
    return proto.sourceDeviceId != null
  }
  ...
  val isSignalMessage: Boolean
     ...
     */
    get() = proto.type === Envelope.Type.DOUBLE_RATCHET
  val isPreKeySignalMessage: Boolean
     ...
     */
    get() = proto.type === Envelope.Type.PREKEY_MESSAGE
  val isReceipt: Boolean
    /**
     * @return true if the containing message is a delivery receipt.
     */
    get() = proto.type === Envelope.Type.SERVER_DELIVERY_RECEIPT
  ...
  fun hasReportingToken(): Boolean {
    return proto.report_spam_token != null
  }

  val reportingToken: ByteArray?
    get() = proto.report_spam_token?.toByteArray()
  ...
  private fun serializeToProto(): SignalServiceEnvelopeProto.Builder {
    ...
    if (sourceServiceId != null) {
      builder.sourceServiceId(sourceServiceId.toString())
    }
